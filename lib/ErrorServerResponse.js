...
function (_Error) {
  ...
  function ErrorServerResponse(statusCode, statusText) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ErrorServerResponse).call(this, message));
    ...
    if (Error.captureStackTrace) {
      Error.captureStackTrace(_assertThisInitialized(_assertThisInitialized(_this)), ErrorServerResponse);
    } else {

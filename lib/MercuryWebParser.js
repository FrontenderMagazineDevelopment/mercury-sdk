...
function () {
   ...
   * @param {string} key - mercury api key
   */
  function MercuryWebParser(key) {
    _classCallCheck(this, MercuryWebParser);
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return (0, _isomorphicFetch.default)("".concat(this.service, "?url=").concat(url), {
                  headers: {
              ...
              case 2:
                ...
                throw new _ErrorServerResponse.default(response.status, response.statusText, MercuryWebParser.message.fail);
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 1:
                if (!(pages.length === 0 || page.next_page_url !== null)) {
                  _context2.next = 8;
                  break;
                }
  ...
  return MercuryWebParser;
}();

exports.default = MercuryWebParser;

_defineProperty(MercuryWebParser, "message", {
